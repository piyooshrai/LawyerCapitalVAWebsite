...
export default function CityServicePage({ params }: Props) {
  ...
  const contentMap: Record<string, Record<string, string>> = {
    ...
    'client-communication': {
      ...
      challenge2: 'Appointment Scheduling Chaos: Clients call with times they are available. Assistant writes them down. Partner emails back. No-shows happen. Reschedules take a week. One VA manages all scheduling, sends calendar invites, sends reminders 24h and 1h before appointments.',
    ...
    'firm-administration': {
      ...
      faq2q: 'What if there is a billing error or audit?',
